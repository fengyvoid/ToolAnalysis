#ifndef LAPPDTimeAlignment_H
#define LAPPDTimeAlignment_H
...
*/
class LAPPDTimeAlignment: public Tool {


    public:

        LAPPDTimeAlignment(); ///< Simple constructor
